...
async def run(loop):
    ...
    await nc.connect("10.128.0.27:4222", loop=loop)
    ...
    async def message_handler(msg):
        ...
        #print(data_dict)
        array_dict = []
        array_dict.append(data_dict)
        errors = client.insert_rows_json('charged-ridge-279113.nats.covid_denormalized_api', array_dict)  # Make an API request.
        if errors == []:
